    ...
    <div className="flex flex-col items-center justify-center space-y-4 px-6">
      <div className="flex flex-row items-center justify-between">
        <div className="flex flex-col items-start justify-center space-y-6">
          ...
          <span className="text-black font-semibold font-comic text-left text-[18px]">
            Some call us truth-tellers, others call us sting bees. Where do you
            buzz? #SBEEtheChange
          </span>
          <span className="text-black font-comic text-left text-[15px]">
            StingScoop is the decentralized platform where anonymity meets
            accountability. Here, we harness the power of zero-knowledge proofs
            to let you share the bloody honest truth about the industry without
            fear of retribution.
          </span>
        ...
        <Image
          src={"/img/hand-holding-phone.svg"}
          alt={"phone"}
          width={450}
          height={450}
        />
      ...
      <div className="flex flex-row items-center justify-between">
        ...
        <div className="flex flex-col items-start justify-center space-y-6 w-[50%]">
          ...
          <span className="text-black font-semibold font-comic text-[18px] text-left">
            Expose bad actors, uncover rug pulls, and shine a light on the dark
            corners of the blockchain world. Every post is a beacon of
            transparency, and every vote is a step towards a more honest
            ecosystem.
          </span>
        </div>
      </div>
      ...
      <div className="flex flex-row items-center justify-between">
        <div className="flex flex-col items-start justify-center space-y-6 w-[50%]">
          ...
          <span className="text-black font-semibold font-comic text-[18px] text-left">
            Connect your wallet, mask your identity, and start buzzing with the
