    ...
    return (
        ...
        >
            ...
            <div className="flex flex-row items-center justify-center space-x-4">
                <Image src={"/img/discord-icn.svg"} alt={"discord"} width={25} height={25} />
                <Image src={"/img/x-icn.svg"} alt={"x"} width={25} height={25} />
                <Image src={"/img/telegram-icn.svg"} alt={"telegram"} width={25} height={25} />
            </div>
        </footer>
    )
}
