        ...
        <div className="flex flex-col z-10 items-start justify-between p-4 md:p-6 w-full md:h-[420px] rounded-xl bg-white border-[2px] border-gray-200 font-comic">
            <div className="flex flex-col items-start justify-center w-full px-4">
                ...
                <span className="text-black text-[25px] text-left font-bold mb-4">
                    Lorem ipsum dolor sit amet consectetur. Et sollicitudin donec turpis lacus consectetur.
                </span>
                {/* content */}
                <span className="text-black text-[20px] text-left mb-4">
                    Lorem ipsum dolor sit amet consectetur. Et sollicitudin donec turpis lacus consectetur in phasellus
                    neque augue. Enim amet volutpat volutpat tincidunt viverra nulla. Blandit ultrices turpis vestibulum
                    sed tortor tortor sit placerat nibh. Arcu ac non risus ut tortor aliquam est.{" "}
